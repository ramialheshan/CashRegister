...
namespace CashRegister
{
    public partial class mainForm : Form
    {
        ...
        {
            JoirnalOperationForm form = new JoirnalOperationForm();
            form.Owner = this;
            switch (form.ShowDialog())
            {
                case DialogResult.OK:
            ...
            switch (form.ShowDialog())
            {
                case DialogResult.OK:
                    ...
                    for (int i = 0; i < ProductListOfCheck.Rows.Count; i++)
                    {
                        ...
                        dRow["Product_CostOfOneOption"]= ProductListOfCheck.Rows[i]["Product_UnitValue"].ToString();
